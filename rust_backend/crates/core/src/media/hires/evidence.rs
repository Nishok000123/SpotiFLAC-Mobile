...
//! how the file was made and whether a LOSSLESS copy would lose anything.
//!
...
//!   quantization noise, nothing in the file exceeds what a 16-bit LOSSLESS
//!   copy holds: "likely", safe to replace.
