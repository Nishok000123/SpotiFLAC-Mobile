...
public class MediaButtonReceiver extends androidx.media.session.MediaButtonReceiver {
    public static final String ACTION_CUSTOM = "com.ryanheise.audioservice.intent.action.CUSTOM";
    ...
    public void onReceive(Context context, Intent intent) {
        if (intent != null && ACTION_CUSTOM.equals(intent.getAction()) && AudioService.instance != null) {
            AudioService.instance.handleCustomNotificationAction(
                intent.getStringExtra("action"), intent.getBundleExtra("extras"));
            return;
        }
        if (intent != null
