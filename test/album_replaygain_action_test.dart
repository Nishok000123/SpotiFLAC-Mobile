...
void main() {
  ...
  for (final mornye in [false, true]) {
    for (final downloaded in [false, true]) {
      testWidgets(
        'ReplayGain survives hiding the album selection (Mornye: $mornye, downloaded: $downloaded)',
        (tester) async {
          ...
          Future<void> openConfirmation() async {
            await tester.tap(find.text(l10n.selectionReplayGainCount(1)));
            await tester.pumpAndSettle();
          ...
          await tester.tap(
            find.descendant(
              ...
              matching: find.text(l10n.replayGainBatchConfirmTitle),
            ),
          );
          await tester.pumpAndSettle();
          expect(attempts, 1);
          expect(find.text(l10n.replayGainBatchSuccess(0, 1)), findsOneWidget);
          expect(find.byType(SelectionBottomBar), findsNothing);
